...
"[project]/.gemini/antigravity/playground/shadow-comet/budget-hub/prisma/client/runtime/library.js [app-rsc] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
function ms() {
    return M.default.join(("TURBOPACK compile-time value", "/ROOT/.gemini/antigravity/playground/shadow-comet/budget-hub/prisma/client/runtime"), "../");
}
var xh = "libquery-engine";
M.default.join(("TURBOPACK compile-time value", "/ROOT/.gemini/antigravity/playground/shadow-comet/budget-hub/prisma/client/runtime"), "../query-engine-darwin");
M.default.join(("TURBOPACK compile-time value", "/ROOT/.gemini/antigravity/playground/shadow-comet/budget-hub/prisma/client/runtime"), "../query-engine-darwin-arm64");
M.default.join(("TURBOPACK compile-time value", "/ROOT/.gemini/antigravity/playground/shadow-comet/budget-hub/prisma/client/runtime"), "../query-engine-debian-openssl-1.0.x");
M.default.join(("TURBOPACK compile-time value", "/ROOT/.gemini/antigravity/playground/shadow-comet/budget-hub/prisma/client/runtime"), "../query-engine-debian-openssl-1.1.x");
M.default.join(("TURBOPACK compile-time value", "/ROOT/.gemini/antigravity/playground/shadow-comet/budget-hub/prisma/client/runtime"), "../query-engine-debian-openssl-3.0.x");
M.default.join(("TURBOPACK compile-time value", "/ROOT/.gemini/antigravity/playground/shadow-comet/budget-hub/prisma/client/runtime"), "../query-engine-linux-static-x64");
M.default.join(("TURBOPACK compile-time value", "/ROOT/.gemini/antigravity/playground/shadow-comet/budget-hub/prisma/client/runtime"), "../query-engine-linux-static-arm64");
M.default.join(("TURBOPACK compile-time value", "/ROOT/.gemini/antigravity/playground/shadow-comet/budget-hub/prisma/client/runtime"), "../query-engine-rhel-openssl-1.0.x");
M.default.join(("TURBOPACK compile-time value", "/ROOT/.gemini/antigravity/playground/shadow-comet/budget-hub/prisma/client/runtime"), "../query-engine-rhel-openssl-1.1.x");
M.default.join(("TURBOPACK compile-time value", "/ROOT/.gemini/antigravity/playground/shadow-comet/budget-hub/prisma/client/runtime"), "../query-engine-rhel-openssl-3.0.x");
M.default.join(("TURBOPACK compile-time value", "/ROOT/.gemini/antigravity/playground/shadow-comet/budget-hub/prisma/client/runtime"), "../libquery_engine-darwin.dylib.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/.gemini/antigravity/playground/shadow-comet/budget-hub/prisma/client/runtime"), "../libquery_engine-darwin-arm64.dylib.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/.gemini/antigravity/playground/shadow-comet/budget-hub/prisma/client/runtime"), "../libquery_engine-debian-openssl-1.0.x.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/.gemini/antigravity/playground/shadow-comet/budget-hub/prisma/client/runtime"), "../libquery_engine-debian-openssl-1.1.x.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/.gemini/antigravity/playground/shadow-comet/budget-hub/prisma/client/runtime"), "../libquery_engine-debian-openssl-3.0.x.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/.gemini/antigravity/playground/shadow-comet/budget-hub/prisma/client/runtime"), "../libquery_engine-linux-arm64-openssl-1.0.x.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/.gemini/antigravity/playground/shadow-comet/budget-hub/prisma/client/runtime"), "../libquery_engine-linux-arm64-openssl-1.1.x.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/.gemini/antigravity/playground/shadow-comet/budget-hub/prisma/client/runtime"), "../libquery_engine-linux-arm64-openssl-3.0.x.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/.gemini/antigravity/playground/shadow-comet/budget-hub/prisma/client/runtime"), "../libquery_engine-linux-musl.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/.gemini/antigravity/playground/shadow-comet/budget-hub/prisma/client/runtime"), "../libquery_engine-linux-musl-openssl-3.0.x.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/.gemini/antigravity/playground/shadow-comet/budget-hub/prisma/client/runtime"), "../libquery_engine-rhel-openssl-1.0.x.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/.gemini/antigravity/playground/shadow-comet/budget-hub/prisma/client/runtime"), "../libquery_engine-rhel-openssl-1.1.x.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/.gemini/antigravity/playground/shadow-comet/budget-hub/prisma/client/runtime"), "../libquery_engine-rhel-openssl-3.0.x.so.node");
M.default.join(("TURBOPACK compile-time value", "/ROOT/.gemini/antigravity/playground/shadow-comet/budget-hub/prisma/client/runtime"), "../query_engine-windows.dll.node");
...
async function ml(e, r) {
    ...
    let o = await ir(), s = r.generator?.binaryTargets ?? [], a = s.some((d)=>d.native), l = !s.some((d)=>d.value === o), u = ("TURBOPACK compile-time value", "/ROOT/.gemini/antigravity/playground/shadow-comet/budget-hub/prisma/client/runtime/library.js").match(Qm()) === null, c = {
        searchedLocations: i,
...
async function Wm(e, r) {
    let t = await ir(), n = [], i = [
        r.dirname,
        St.default.resolve(("TURBOPACK compile-time value", "/ROOT/.gemini/antigravity/playground/shadow-comet/budget-hub/prisma/client/runtime"), ".."),
        r.generator?.output?.value ?? ("TURBOPACK compile-time value", "/ROOT/.gemini/antigravity/playground/shadow-comet/budget-hub/prisma/client/runtime"),
        St.default.resolve(("TURBOPACK compile-time value", "/ROOT/.gemini/antigravity/playground/shadow-comet/budget-hub/prisma/client/runtime"), "../../../.prisma/client"),
        "/tmp/prisma-engines",
        r.cwd
    ];
    ("TURBOPACK compile-time value", "/ROOT/.gemini/antigravity/playground/shadow-comet/budget-hub/prisma/client/runtime/library.js").includes("resolveEnginePath") && i.push(ms());
    for (let o of i){
...
"[project]/.gemini/antigravity/playground/shadow-comet/budget-hub/prisma/client/index.js [app-rsc] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
const { PrismaClientKnownRequestError, PrismaClientUnknownRequestError, PrismaClientRustPanicError, PrismaClientInitializationError, PrismaClientValidationError, getPrismaClient, sqltag, empty, join, raw, skip, Decimal, Debug, objectEnumValues, makeStrictEnum, Extensions, warnOnce, defineDmmfProperty, Public, getRuntime, createParam } = __turbopack_context__.r("[project]/.gemini/antigravity/playground/shadow-comet/budget-hub/prisma/client/runtime/library.js [app-rsc] (ecmascript)");
const Prisma = {};
 ...
 */ const config = {
    ...
    "inlineSchemaHash": "75eb8fe9c018786f3c543e6a97ae925220207688f1484fe1723f7f66c75a248b",
    "copyEngine": true
};
const fs = __turbopack_context__.r("[externals]/fs [external] (fs, cjs)");
config.dirname = ("TURBOPACK compile-time value", "/ROOT/.gemini/antigravity/playground/shadow-comet/budget-hub/prisma/client");
if (!fs.existsSync(path.join(("TURBOPACK compile-time value", "/ROOT/.gemini/antigravity/playground/shadow-comet/budget-hub/prisma/client"), 'schema.prisma'))) {
...
path.join(("TURBOPACK compile-time value", "/ROOT/.gemini/antigravity/playground/shadow-comet/budget-hub/prisma/client"), "libquery_engine-darwin-arm64.dylib.node");
path.join(process.cwd(), "prisma/client/libquery_engine-darwin-arm64.dylib.node");
// file annotations for bundling tools to include these files
path.join(("TURBOPACK compile-time value", "/ROOT/.gemini/antigravity/playground/shadow-comet/budget-hub/prisma/client"), "schema.prisma");
path.join(process.cwd(), "prisma/client/schema.prisma");
}),
"[project]/.gemini/antigravity/playground/shadow-comet/budget-hub/src/lib/prisma.ts [app-rsc] (ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f2e$gemini$2f$antigravity$2f$playground$2f$shadow$2d$comet$2f$budget$2d$hub$2f$prisma$2f$client$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/.gemini/antigravity/playground/shadow-comet/budget-hub/prisma/client/index.js [app-rsc] (ecmascript)");
;
;
const globalForPrisma = globalThis;
// Force a new instance when needed, though local import usually fixes it
const prismaInstance = globalForPrisma.prisma ?? new __TURBOPACK__imported__module__$5b$project$5d2f2e$gemini$2f$antigravity$2f$playground$2f$shadow$2d$comet$2f$budget$2d$hub$2f$prisma$2f$client$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["PrismaClient"]();
...
"[project]/.gemini/antigravity/playground/shadow-comet/budget-hub/src/app/dashboard/dre/DreView.tsx [app-rsc] (ecmascript)", ((__turbopack_context__, module, exports) => {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__60d39c37._.js.map
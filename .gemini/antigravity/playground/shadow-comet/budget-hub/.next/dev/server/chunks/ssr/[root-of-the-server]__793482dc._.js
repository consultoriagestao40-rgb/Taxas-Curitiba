...
/* __next_internal_action_entry_do_not_use__ [{"7c01bcad98ba33d51c0d9792357959a35159857cad":"batchUpdateBudgetEntries","7e209cdeca4997b80facfb59bad953034312b1b39e":"updateBudgetEntry"},"",""] */ __turbopack_context__.s([
...
;
;
async function updateBudgetEntry(tenantId, accountId, month, year, amount, dimensions) {
    // 1. Auth Check
    const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f2e$gemini$2f$antigravity$2f$playground$2f$shadow$2d$comet$2f$budget$2d$hub$2f$node_modules$2f$iron$2d$session$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getIronSession"])(await (0, __TURBOPACK__imported__module__$5b$project$5d2f2e$gemini$2f$antigravity$2f$playground$2f$shadow$2d$comet$2f$budget$2d$hub$2f$node_modules$2f$next$2f$headers$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["cookies"])(), __TURBOPACK__imported__module__$5b$project$5d2f2e$gemini$2f$antigravity$2f$playground$2f$shadow$2d$comet$2f$budget$2d$hub$2f$src$2f$lib$2f$session$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["sessionOptions"]);
    ...
    // 2. Permission Check
    // If user is ADMIN, allow all. validation
    // If user is USER, check specific permission for Company and CostCenter
    if (session.role !== 'ADMIN') {
        const userPermissions = await __TURBOPACK__imported__module__$5b$project$5d2f2e$gemini$2f$antigravity$2f$playground$2f$shadow$2d$comet$2f$budget$2d$hub$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].userPermission.findMany({
            where: {
                userId: session.userId
            }
        });
        // Check Company Permission
        // If user has NO company permissions, maybe they are allowed none? Or all? 
        // Logic: If list is empty, default to DENY? Or if they have a permission entry, it restricts?
        // Let's assume: If you have permissions in table, you are restricted to those. If table empty? 
        // Based on Seed, we created permissions for Restricted user.
        // Let's implement: If you have "Company Permission" entries, you must match one.
        const companyPerms = userPermissions.filter((p)=>p.companyId);
        if (companyPerms.length > 0) {
            const hasAccess = companyPerms.some((p)=>p.companyId === dimensions.companyId);
            if (!hasAccess) {
                throw new Error('Forbidden: No access to this Company');
            }
        }
        // Check CostCenter Permission
        if (dimensions.costCenterId) {
            const ccPerms = userPermissions.filter((p)=>p.costCenterId);
            if (ccPerms.length > 0) {
                const hasAccess = ccPerms.some((p)=>p.costCenterId === dimensions.costCenterId);
                if (!hasAccess) {
                    throw new Error('Forbidden: No access to this Cost Center');
                }
            }
        }
    }
...
async function batchUpdateBudgetEntries(tenantId, accountId, year, entries, dimensions) {
    const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f2e$gemini$2f$antigravity$2f$playground$2f$shadow$2d$comet$2f$budget$2d$hub$2f$node_modules$2f$iron$2d$session$2f$dist$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getIronSession"])(await (0, __TURBOPACK__imported__module__$5b$project$5d2f2e$gemini$2f$antigravity$2f$playground$2f$shadow$2d$comet$2f$budget$2d$hub$2f$node_modules$2f$next$2f$headers$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["cookies"])(), __TURBOPACK__imported__module__$5b$project$5d2f2e$gemini$2f$antigravity$2f$playground$2f$shadow$2d$comet$2f$budget$2d$hub$2f$src$2f$lib$2f$session$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["sessionOptions"]);
    if (!session.isLoggedIn || session.tenantId !== tenantId) throw new Error('Unauthorized');
    // Permission checks (same as single update - reusing logic would be better but duplicating for MVP speed)
    if (session.role !== 'ADMIN') {
        const userPermissions = await __TURBOPACK__imported__module__$5b$project$5d2f2e$gemini$2f$antigravity$2f$playground$2f$shadow$2d$comet$2f$budget$2d$hub$2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__$3c$locals$3e$__["prisma"].userPermission.findMany({
            where: {
                userId: session.userId
        ...
        const companyPerms = userPermissions.filter((p)=>p.companyId);
        if (companyPerms.length > 0) {
            if (!companyPerms.some((p)=>p.companyId === dimensions.companyId)) {
                throw new Error('Forbidden: No access to this Company');
            }
        }
        if (dimensions.costCenterId) {
            const ccPerms = userPermissions.filter((p)=>p.costCenterId);
            if (ccPerms.length > 0 && !ccPerms.some((p)=>p.costCenterId === dimensions.costCenterId)) {
                throw new Error('Forbidden: No access to this Cost Center');
            }
        }
    }
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f2e$gemini$2f$antigravity$2f$playground$2f$shadow$2d$comet$2f$budget$2d$hub$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(updateBudgetEntry, "7e209cdeca4997b80facfb59bad953034312b1b39e", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f2e$gemini$2f$antigravity$2f$playground$2f$shadow$2d$comet$2f$budget$2d$hub$2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(batchUpdateBudgetEntries, "7c01bcad98ba33d51c0d9792357959a35159857cad", null);
}),
...
"[project]/.gemini/antigravity/playground/shadow-comet/budget-hub/.next-internal/server/app/dashboard/dre/page/actions.js { ACTIONS_MODULE0 => \"[project]/.gemini/antigravity/playground/shadow-comet/budget-hub/src/app/actions/settings.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/.gemini/antigravity/playground/shadow-comet/budget-hub/src/app/actions/budget.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE2 => \"[project]/.gemini/antigravity/playground/shadow-comet/budget-hub/src/app/actions/account.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript) <locals>", ((__turbopack_context__) => {
"use strict";
...
"[project]/.gemini/antigravity/playground/shadow-comet/budget-hub/.next-internal/server/app/dashboard/dre/page/actions.js { ACTIONS_MODULE0 => \"[project]/.gemini/antigravity/playground/shadow-comet/budget-hub/src/app/actions/settings.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE1 => \"[project]/.gemini/antigravity/playground/shadow-comet/budget-hub/src/app/actions/budget.ts [app-rsc] (ecmascript)\", ACTIONS_MODULE2 => \"[project]/.gemini/antigravity/playground/shadow-comet/budget-hub/src/app/actions/account.ts [app-rsc] (ecmascript)\" } [app-rsc] (server actions loader, ecmascript)", ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s([
    ...
    "7c01bcad98ba33d51c0d9792357959a35159857cad",
...
var __TURBOPACK__imported__module__$5b$project$5d2f2e$gemini$2f$antigravity$2f$playground$2f$shadow$2d$comet$2f$budget$2d$hub$2f2e$next$2d$internal$2f$server$2f$app$2f$dashboard$2f$dre$2f$page$2f$actions$2e$js__$7b$__ACTIONS_MODULE0__$3d3e$__$225b$project$5d2f2e$gemini$2f$antigravity$2f$playground$2f$shadow$2d$comet$2f$budget$2d$hub$2f$src$2f$app$2f$actions$2f$settings$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE1__$3d3e$__$225b$project$5d2f2e$gemini$2f$antigravity$2f$playground$2f$shadow$2d$comet$2f$budget$2d$hub$2f$src$2f$app$2f$actions$2f$budget$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29222c$__ACTIONS_MODULE2__$3d3e$__$225b$project$5d2f2e$gemini$2f$antigravity$2f$playground$2f$shadow$2d$comet$2f$budget$2d$hub$2f$src$2f$app$2f$actions$2f$account$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$2922$__$7d$__$5b$app$2d$rsc$5d$__$28$server__actions__loader$2c$__ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i('[project]/.gemini/antigravity/playground/shadow-comet/budget-hub/.next-internal/server/app/dashboard/dre/page/actions.js { ACTIONS_MODULE0 => "[project]/.gemini/antigravity/playground/shadow-comet/budget-hub/src/app/actions/settings.ts [app-rsc] (ecmascript)", ACTIONS_MODULE1 => "[project]/.gemini/antigravity/playground/shadow-comet/budget-hub/src/app/actions/budget.ts [app-rsc] (ecmascript)", ACTIONS_MODULE2 => "[project]/.gemini/antigravity/playground/shadow-comet/budget-hub/src/app/actions/account.ts [app-rsc] (ecmascript)" } [app-rsc] (server actions loader, ecmascript) <locals>');
var __TURBOPACK__imported__module__$5b$project$5d2f2e$gemini$2f$antigravity$2f$playground$2f$shadow$2d$comet$2f$budget$2d$hub$2f$src$2f$app$2f$actions$2f$settings$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/.gemini/antigravity/playground/shadow-comet/budget-hub/src/app/actions/settings.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f2e$gemini$2f$antigravity$2f$playground$2f$shadow$2d$comet$2f$budget$2d$hub$2f$src$2f$app$2f$actions$2f$budget$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/.gemini/antigravity/playground/shadow-comet/budget-hub/src/app/actions/budget.ts [app-rsc] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f2e$gemini$2f$antigravity$2f$playground$2f$shadow$2d$comet$2f$budget$2d$hub$2f$src$2f$app$2f$actions$2f$account$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/.gemini/antigravity/playground/shadow-comet/budget-hub/src/app/actions/account.ts [app-rsc] (ecmascript)");
}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__793482dc._.js.map